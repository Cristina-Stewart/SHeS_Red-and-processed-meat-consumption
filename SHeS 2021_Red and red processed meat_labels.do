...
label variable Avg_Location_Supermarket_RRPM "Avg daily intake (g) of RRPM Locationd from supermarkets"
label variable Avg_Location_Restaurants_RRPM "Avg daily intake (g) of RRPM Locationd from cafes, restaurants, pubs & takeaways"
label variable Avg_Location_Other_RRPM "Avg daily intake (g) of RRPM Locationd from other locations"

label variable Prop_Location_Supermarket_RRPM "% contribution of RRPM Locationd from supermarkets"
label variable Prop_Location_Restaurants_RRPM "% contribution of RRPM Locationd from cafes, restaurants, pubs & takeaways"
label variable Prop_Location_Other_RRPM "% contribution of RRPM Locationd from other locations"

*Unprocessed vs processed
label variable Avg_Day_RedProcessed "Avg intake (g) of processed red meat"
label variable Avg_Day_RedUnprocessed "Avg intake (g) of unprocessed red meat"
label variable Prop_RedProcessed "% contribution of processed red meat to total RPM intake"

label variable Prop_RedProcessed "Proportion (%) of RPM that is processed"
label variable Prop_RedUnprocessed "Proportion (%) of RPM that is unprocessed"

label variable Prop_BeefProcessed "Proportion (%) of processed meat that is beef"
label variable Prop_LambProcessed "Proportion (%) of processed meat that is lamb"
label variable Prop_PorkProcessed "Proportion (%) of processed meat that is pork"
label variable Prop_GameProcessed "Proportion (%) of processed meat that is game"
...
label variable rrpmg "grams of red and red processed meat per portion"
label variable totalredprocessed "grams of red processed meat per portion"
label variable totalredunprocessed "grams of red unprocessed meat per portion"
